...
BOOST_AUTO_TEST_CASE(ResultSetDescriptor)
{
    ...
    {
        const auto rset = ::Ewoms::EclIO::OutputStream::ResultSet {
            odir, "CASE"
        };
...
BOOST_AUTO_TEST_CASE(Unformatted)
{
    ...
    {
        auto init = ::Ewoms::EclIO::OutputStream::Init {
            rset, fmt
        };
...

    {
        ...
        auto init = ::Ewoms::EclIO::EclFile{fname};
...

    {
...

        {
            const auto vectors        = init.getList();
            const auto expect_vectors = std::vector<Ewoms::EclIO::EclFile::EclEntry>{
                Ewoms::EclIO::EclFile::EclEntry{"I2", Ewoms::EclIO::eclArrType::INTE, 6},
                Ewoms::EclIO::EclFile::EclEntry{"L2", Ewoms::EclIO::eclArrType::LOGI, 4},
                Ewoms::EclIO::EclFile::EclEntry{"S2", Ewoms::EclIO::eclArrType::REAL, 3},
                Ewoms::EclIO::EclFile::EclEntry{"D2", Ewoms::EclIO::eclArrType::DOUB, 3},
            };
...
BOOST_AUTO_TEST_CASE(Unformatted_Unified)
{
    const auto rset = RSet("CASE");
    const auto fmt  = ::Ewoms::EclIO::OutputStream::Formatted{ false };
    const auto unif = ::Ewoms::EclIO::OutputStream::Unified  { true };
...

    {
...

        {
            ...
            const auto expect_vectors = std::vector<Ewoms::EclIO::EclFile::EclEntry>{
                Ewoms::EclIO::EclFile::EclEntry{"SEQNUM", Ewoms::EclIO::eclArrType::INTE, 1},
...
BOOST_AUTO_TEST_CASE(Formatted_Separate)
{
...

    {
        ...
        auto rst = ::Ewoms::EclIO::EclFile{fname};
...
{
    using Char8 = ::Ewoms::EclIO::PaddedOutputString<8>;

    const auto rset  = RSet("CASE");
    const auto fmt   = ::Ewoms::EclIO::OutputStream::Formatted{ false };
    const auto exist = ::Ewoms::EclIO::OutputStream::RFT::OpenExisting{ false };

    {
        auto rft = ::Ewoms::EclIO::OutputStream::RFT {
            rset, fmt, exist
        };
...

    {
        ...
        auto rft = ::Ewoms::EclIO::EclFile{fname};
...

    {
...

        {
            const auto vectors        = rft.getList();
            const auto expect_vectors = std::vector<Ewoms::EclIO::EclFile::EclEntry>{
                Ewoms::EclIO::EclFile::EclEntry{"I2", Ewoms::EclIO::eclArrType::INTE, 3},
                Ewoms::EclIO::EclFile::EclEntry{"S2", Ewoms::EclIO::eclArrType::REAL, 3},
                Ewoms::EclIO::EclFile::EclEntry{"Z2", Ewoms::EclIO::eclArrType::CHAR, 3},
            };
...
BOOST_AUTO_TEST_CASE(Unformatted_Existing)
{
    ...
    const auto rset  = RSet("CASE");
    const auto fmt   = ::Ewoms::EclIO::OutputStream::Formatted{ false };
    const auto exist = ::Ewoms::EclIO::OutputStream::RFT::OpenExisting{ true };
...
namespace {
    ...
    Ewoms::EclIO::OutputStream::SummarySpecification::StartTime
    ...
    Ewoms::EclIO::OutputStream::SummarySpecification::RestartSpecification
    noRestart()
    {
        return { "", -1 };
    }
    ...
    Ewoms::EclIO::OutputStream::SummarySpecification::Parameters
    summaryParameters()
    {
        auto prm = Ewoms::EclIO::OutputStream::
...
{
    using SMSpec = ::Ewoms::EclIO::OutputStream::SummarySpecification;
...

    {
        ...
        auto smspec = ::Ewoms::EclIO::EclFile{fname};
...

        {
            ...
            const auto expect_vectors = std::vector<Ewoms::EclIO::EclFile::EclEntry>{
                Ewoms::EclIO::EclFile::EclEntry{"INTEHEAD", Ewoms::EclIO::eclArrType::INTE, 2},
                Ewoms::EclIO::EclFile::EclEntry{"RESTART", Ewoms::EclIO::eclArrType::CHAR, 9},
                Ewoms::EclIO::EclFile::EclEntry{"DIMENS", Ewoms::EclIO::eclArrType::INTE, 6},
                Ewoms::EclIO::EclFile::EclEntry{"KEYWORDS", Ewoms::EclIO::eclArrType::CHAR, 4},
                Ewoms::EclIO::EclFile::EclEntry{"WGNAMES", Ewoms::EclIO::eclArrType::CHAR, 4},
                Ewoms::EclIO::EclFile::EclEntry{"NUMS", Ewoms::EclIO::eclArrType::INTE, 4},
                Ewoms::EclIO::EclFile::EclEntry{"UNITS", Ewoms::EclIO::eclArrType::CHAR, 4},
                Ewoms::EclIO::EclFile::EclEntry{"STARTDAT", Ewoms::EclIO::eclArrType::INTE, 6},
            };
