...
10 /
    ...
    Ewoms::Deck msw_sim(std::string fname) {
        return Ewoms::Parser{}.parseFile(fname);
    }

   Ewoms::SummaryState sim_state()
    {
    ...
    Ewoms::data::WellRates well_rates_1()
    {
        using o = ::Ewoms::data::Rates::opt;

        auto xw = ::Ewoms::data::WellRates{};

        {
            ...
            curr.prod = ::Ewoms::Well::ProducerCMode::GRAT;
        }

        {
            ...
            curr.inj = ::Ewoms::Well::InjectorCMode::RATE;
        }

        return xw;
    }

    Ewoms::data::WellRates well_rates_2()
    {
        using o = ::Ewoms::data::Rates::opt;
...

        {
            ...
            auto& curr = xw["OP_1"].current_control;
            curr.isProducer = true;
            curr.prod = ::Ewoms::Well::ProducerCMode::NONE;
        }
...
BOOST_AUTO_TEST_CASE (Constructor)
{
    ...
    const auto awd = Ewoms::RestartIO::Helpers::AggregateWellData{ ih.value };
...
BOOST_AUTO_TEST_CASE (Declared_Well_Data)
{
    ...
    auto awd = Ewoms::RestartIO::Helpers::AggregateWellData{ih.value};
    ...
    //smry = sim_state();
    awd = Ewoms::RestartIO::Helpers::AggregateWellData{ih_8.value};
    awd.captureDeclaredWellData(simCase.sched,
