...
BOOST_AUTO_TEST_CASE(P1_First)
{
    ...
    // GR_{oil}
    {
        const auto grval = cse.gr.get("P1", Ewoms::Well::GuideRateTarget::OIL, { orat, grat, wrat });
    ...
    // GR_{gas}
    {
        const auto grval = cse.gr.get("P1", Ewoms::Well::GuideRateTarget::GAS, { orat, grat, wrat });
    ...
    // GR_{water}
    {
        const auto grval = cse.gr.get("P1", Ewoms::Well::GuideRateTarget::WAT, { orat, grat, wrat });
...
BOOST_AUTO_TEST_CASE(P2_Second)
{
...

    {
        ...
        const auto wwpp = 1.0;
        const auto stm  = 10.0*Ewoms::unit::second; // Before recalculation delay
        const auto rpt  = size_t{1};
    ...
    // GR_{oil}
    {
        const auto grval = cse.gr.get("P2", Ewoms::Well::GuideRateTarget::OIL, { orat, grat, wrat });
    ...
    // GR_{gas}
    {
        const auto grval = cse.gr.get("P2", Ewoms::Well::GuideRateTarget::GAS, { orat, grat, wrat });
    ...
    // GR_{water}
    {
        const auto grval = cse.gr.get("P2", Ewoms::Well::GuideRateTarget::WAT, { orat, grat, wrat });
...

    {
        ...
        const auto wgpp = 50.0;
        const auto wwpp = 1.0;
        const auto stm  = 10.0*Ewoms::unit::day; // After recalculation delay
...
BOOST_AUTO_TEST_CASE(P_Third)
{
...

    {
        ...
        const auto wgpp = 50.0;
        const auto wwpp = 1.0;
        const auto stm  = 10.0*Ewoms::unit::day;
        const auto rpt  = size_t{3};
...

    {
        ...
        const auto stm  = 20.0*Ewoms::unit::day;
    ...
    // GR_{oil}
    {
        const auto grval = cse.gr.get("P", Ewoms::Well::GuideRateTarget::OIL, { orat, grat, wrat });
    ...
    // GR_{gas}
    {
        const auto grval = cse.gr.get("P", Ewoms::Well::GuideRateTarget::GAS, { orat, grat, wrat });
    ...
    // GR_{water}
    {
        const auto grval = cse.gr.get("P", Ewoms::Well::GuideRateTarget::WAT, { orat, grat, wrat });
