...
BOOST_AUTO_TEST_CASE(METRIC_UNITS)
{
    ...
    BOOST_CHECK( metric.getType() == Ewoms::UnitSystem::UnitType::UNIT_TYPE_METRIC );
...
BOOST_AUTO_TEST_CASE(FIELD_UNITS)
{
    ...
    BOOST_CHECK( field.getType() == Ewoms::UnitSystem::UnitType::UNIT_TYPE_FIELD );
...
BOOST_AUTO_TEST_CASE(LAB_UNITS)
{
    ...
    BOOST_CHECK( lab.getType() == Ewoms::UnitSystem::UnitType::UNIT_TYPE_LAB );
...
BOOST_AUTO_TEST_CASE(PVT_M_UNITS)
{
    ...
    BOOST_CHECK( pvt_m.getType() == Ewoms::UnitSystem::UnitType::UNIT_TYPE_PVT_M );
