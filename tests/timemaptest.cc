...
const std::time_t startDateJan1st2010 = Ewoms::TimeMap::mkdate(2010, 1, 1);
...
BOOST_AUTO_TEST_CASE( dateFromEclipseThrowsInvalidRecord ) {
    Ewoms::DeckRecord startRecord;
    Ewoms::DeckItem dayItem("DAY", int() );
    Ewoms::DeckItem monthItem("MONTH", std::string() );
    Ewoms::DeckItem yearItem("YEAR", int() );
    Ewoms::DeckItem timeItem("TIME", std::string() );
    Ewoms::DeckItem extraItem("EXTRA", int() );
    ...
    BOOST_CHECK_THROW( Ewoms::TimeMap::timeFromEclipse( startRecord ) , std::out_of_range );
    ...
    BOOST_CHECK_NO_THROW(Ewoms::TimeMap::timeFromEclipse( startRecord ));
}
...
BOOST_AUTO_TEST_CASE( timeFromEclipseCheckMonthNames ) {
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 1, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "JAN", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 2, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "FEB", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 3, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "MAR", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 4, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "APR", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 5, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "MAI", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 5, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "MAY", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 6, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "JUN", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 7, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "JUL", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 7, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "JLY", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 8, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "AUG", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 9, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "SEP", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 10, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "OKT", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 10, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "OCT", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 11, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "NOV", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 12, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "DEC", 2000)));
    BOOST_CHECK_EQUAL( Ewoms::TimeMap::mkdate(2000, 12, 1), Ewoms::TimeMap::timeFromEclipse(createDeckRecord(1, "DES", 2000)));
}
...
BOOST_AUTO_TEST_CASE(TimeStepsCorrect) {
    ...
    Ewoms::Parser parser( true );
    auto deck = parser.parseString(deckData);
    Ewoms::TimeMap tmap(deck);

    BOOST_CHECK_EQUAL(tmap.getStartTime(0),Ewoms::TimeMap::mkdate( 1981 , 5 , 21 ));
    ...
    BOOST_CHECK_EQUAL(tmap.getStartTime(1),
                      Ewoms::TimeMap::forward( Ewoms::TimeMap::mkdate( 1981 , 5 , 21 ) , 3600*24));
    ...
    BOOST_CHECK_EQUAL(tmap.getStartTime(2),
                      Ewoms::TimeMap::forward( Ewoms::TimeMap::mkdate( 1981 , 5 , 21 ) , 3*24*3600));
    ...
    BOOST_CHECK_EQUAL(tmap.getStartTime(3),
                      Ewoms::TimeMap::forward( Ewoms::TimeMap::mkdate( 1981 , 5 , 21 ) , 6*3600*24));
    ...
    BOOST_CHECK_EQUAL(tmap.getStartTime(4),
                      Ewoms::TimeMap::forward( Ewoms::TimeMap::mkdate( 1981 , 5 , 21 ) , 10*3600*24));
    ...
    BOOST_CHECK_EQUAL(tmap.getStartTime(5),
                      Ewoms::TimeMap::forward( Ewoms::TimeMap::mkdate( 1981 , 5 , 21 ) , 15*3600*24));
    ...
    BOOST_CHECK_EQUAL(tmap.getStartTime(6),
                      Ewoms::TimeMap::mkdate( 1982 , 1 , 1 ));

    BOOST_CHECK_EQUAL(tmap.getStartTime(7),
                      Ewoms::TimeMap::forward( Ewoms::TimeMap::mkdate( 1982 , 1 , 1 ) , 13,55,44 ));

    BOOST_CHECK_EQUAL(tmap.getStartTime(8),
                      Ewoms::TimeMap::forward( Ewoms::TimeMap::mkdate( 1982 , 1 , 3 ) , 14,56,45));
...
BOOST_AUTO_TEST_CASE(initTimestepsLongStep) {
    ...
    const auto tEnd = Ewoms::TimeStampUTC { tmap.getEndTime() };
...
BOOST_AUTO_TEST_CASE(initTimestepsDistantDates) {
    ...
    const auto t1 = Ewoms::TimeStampUTC { tmap.getStartTime(1) };
    const auto t2 = Ewoms::TimeStampUTC { tmap.getEndTime() };
...
BOOST_AUTO_TEST_CASE(mkdate) {
    BOOST_CHECK_THROW( Ewoms::TimeMap::mkdate( 2010 , 0 , 0  ) , std::invalid_argument);
    auto t0 = Ewoms::TimeStampUTC { Ewoms::TimeMap::mkdate( 2010 , 1, 1) };
    auto t1 = Ewoms::TimeStampUTC { Ewoms::TimeMap::forward( asTimeT(t0) , 24*3600) };

    BOOST_CHECK_EQUAL( t1.year() , 2010 );
    BOOST_CHECK_EQUAL( t1.month() , 1 );
    BOOST_CHECK_EQUAL( t1.day() , 2 );

    t1 = Ewoms::TimeMap::forward( asTimeT(t1) , -24*3600);
    BOOST_CHECK_EQUAL( t1.year() , 2010 );
    BOOST_CHECK_EQUAL( t1.month() , 1 );
    BOOST_CHECK_EQUAL( t1.day() , 1 );

    t1 = Ewoms::TimeMap::forward( asTimeT(t0) , 23, 55 , 300);
    BOOST_CHECK_EQUAL( t1.year() , 2010 );
    BOOST_CHECK_EQUAL( t1.month() , 1 );
    BOOST_CHECK_EQUAL( t1.day() , 2 );
...
BOOST_AUTO_TEST_CASE(mkdatetime) {
    BOOST_CHECK_THROW(Ewoms::TimeMap::mkdatetime(2010, 0, 0, 0, 0, 0), std::invalid_argument);
    auto t0 = Ewoms::TimeStampUTC { Ewoms::TimeMap::mkdatetime(2010, 1, 1, 0, 0, 0) };
    auto t1 = Ewoms::TimeStampUTC { Ewoms::TimeMap::forward(asTimeT(t0), 24 * 3600) };
...
Ewoms::DeckRecord createDeckRecord(int day, const std::string &month, int year, const std::string &time) {
    Ewoms::DeckRecord deckRecord;
    Ewoms::DeckItem dayItem("DAY", int() );
    Ewoms::DeckItem monthItem("MONTH", std::string() );
    Ewoms::DeckItem yearItem("YEAR", int() );
    Ewoms::DeckItem timeItem("TIME", std::string() );
...
/
    ...
    BOOST_CHECK_THROW( Ewoms::TimeMap(deck1, invalid_restart) , std::exception);
...
2 /       -- <- Restart from here  5
    ...
    auto restart = std::make_pair(Ewoms::asTimeT(Ewoms::TimeStampUTC(2005, 1, 2)), 5);
    BOOST_CHECK_THROW( Ewoms::TimeMap(deck1, restart) , std::exception);
