...
BOOST_AUTO_TEST_CASE(CreateGroupCreateTimeOK) {
    Ewoms::Group group("G1" , 1, 5, 0, UnitSystem::newMETRIC());
...
BOOST_AUTO_TEST_CASE(CreateGroup_SetInjectorProducer_CorrectStatusSet) {
    Ewoms::Group group1("IGROUP" , 1,  0, 0, UnitSystem::newMETRIC());
    Ewoms::Group group2("PGROUP" , 2,  0, 0, UnitSystem::newMETRIC());
...
BOOST_AUTO_TEST_CASE(GroupCreate) {
    Ewoms::Group g1("NAME", 1, 1, 0, UnitSystem::newMETRIC());
    Ewoms::Group g2("NAME", 1, 1, 0, UnitSystem::newMETRIC());
...
BOOST_AUTO_TEST_CASE(TESTGuideRateModel) {
    Ewoms::GuideRateModel grc_default;
    BOOST_CHECK_THROW(Ewoms::GuideRateModel(0.0,GuideRateModel::Target::OIL, -5,0,0,0,0,0,true,1,true), std::invalid_argument);
    BOOST_CHECK_THROW(grc_default.eval(1,0.50,0.50), std::invalid_argument);

    Ewoms::GuideRateModel grc_delay(10, GuideRateModel::Target::OIL, 1,1,0,0,0,0,true,1,true);
