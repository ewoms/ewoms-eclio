...
BOOST_AUTO_TEST_CASE (Constructor)
{
    ...
    const auto amconn = Ewoms::RestartIO::Helpers::AggregateConnectionData{ ih.value };
...
BOOST_AUTO_TEST_CASE(Declared_Connection_Data)
{
    ...
    const Ewoms::data::WellRates wrc = wr(simCase.sched);
    auto amconn = Ewoms::RestartIO::Helpers::AggregateConnectionData {ih.value};
...
BOOST_AUTO_TEST_CASE(InactiveCell) {
    ...
    const auto ih = MockIH {static_cast<int>(simCase.sched.getWells(rptStep).size())};
    const Ewoms::data::WellRates wrc = wr(simCase.sched);
    auto conn0 = Ewoms::RestartIO::Helpers::AggregateConnectionData{ih.value};
    ...
    auto conn1 = Ewoms::RestartIO::Helpers::AggregateConnectionData{ih.value};
    ...
    {
        using IC = ::Ewoms::RestartIO::Helpers::VectorItems::IConn::index;
