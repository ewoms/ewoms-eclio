...
#include <ewoms/eclio/output/intehead.hh> // ewoms::restartio::makeutctime()
...
namespace {
    ...
    double toDateNum(const std::chrono::time_point<std::chrono::system_clock> tp)
    {
        ...
        const auto t1 = ::Ewoms::RestartIO::makeUTCTime(tm1);
...
Ewoms::RestartIO::DoubHEAD::DoubHEAD()
...
Ewoms::RestartIO::DoubHEAD&
Ewoms::RestartIO::DoubHEAD::tuningParameters(const Tuning&     tuning,
                                           const double      cnvT)
{
    // Record 1
...
Ewoms::RestartIO::DoubHEAD&
Ewoms::RestartIO::DoubHEAD::timeStamp(const TimeStamp& ts)
{
...
Ewoms::RestartIO::DoubHEAD&
Ewoms::RestartIO::DoubHEAD::nextStep(const double nextTimeStep)
{
    if (nextTimeStep > 0.0) {
...
Ewoms::RestartIO::DoubHEAD&
Ewoms::RestartIO::DoubHEAD::drsdt(const Schedule&   sched,
				...
				const double      cnvT)
{
    ...
    this->data_[dRsdt] =
        (vappar.getType() == Ewoms::OilVaporizationProperties::OilVaporization::DRDT)
...
Ewoms::RestartIO::DoubHEAD&
Ewoms::RestartIO::DoubHEAD::udq_param(const UDQParams& udqPar)
{
...
Ewoms::RestartIO::DoubHEAD&
Ewoms::RestartIO::DoubHEAD::guide_rate_param(const guideRate& guide_rp)
{
...
Ewoms::RestartIO::DoubHEAD&
Ewoms::RestartIO::DoubHEAD::lift_opt_param(const liftOptPar& lo_par)
{
