...
namespace {
    ...
    std::string header_days(const Ewoms::Schedule& schedule, std::size_t report_step) {
    ...
    std::string report_line(const Ewoms::Schedule& schedule, std::size_t report_step) {
