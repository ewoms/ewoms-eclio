...
#ifndef EWOMS_OUTPUT_ECLIPSE_VECTOR_WELL_H
#define EWOMS_OUTPUT_ECLIPSE_VECTOR_WELL_H
...
namespace Ewoms { namespace RestartIO { namespace Helpers { namespace VectorItems {
    ...
    namespace IWell {
        ...
        namespace Value {
            enum WellType : int {
                WTUnk    = 0,  // Unknown well type (eWoms and OPM only)
...
#endif // EWOMS_OUTPUT_ECLIPSE_VECTOR_WELL_H
