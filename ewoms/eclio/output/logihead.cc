...
Ewoms::RestartIO::LogiHEAD::LogiHEAD()
    : data_(LOGIHEAD_NUMBER_OF_ITEMS, false)
{}

Ewoms::RestartIO::LogiHEAD&
Ewoms::RestartIO::LogiHEAD::
...
Ewoms::RestartIO::LogiHEAD&
Ewoms::RestartIO::LogiHEAD::pvtModel(const PVTModel& pvt)
{
...
Ewoms::RestartIO::LogiHEAD&
Ewoms::RestartIO::LogiHEAD::saturationFunction(const SatfuncFlags& satfunc)
{
