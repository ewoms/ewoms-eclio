...
namespace {
    ...
    namespace ZWell {
        ...
        Ewoms::RestartIO::Helpers::ActionResStatus
        ...
        void staticContrib(const Ewoms::Well& well, const Ewoms::RestartIO::Helpers::ActionResStatus& actResStat, ZWellArray& zWell)
        {
