...
#ifndef EWOMS_OUTPUT_WRITER_H
#define EWOMS_OUTPUT_WRITER_H

#include <ewoms/eclio/parser/eclipsestate/grid/nnc.hh>

#include <ewoms/eclio/output/cells.hh>
#include <ewoms/eclio/output/wells.hh>
