...
//
//     ewoms/eclio/output/VectorItems/intehead.hh
//
...
Ewoms::RestartIO::InteHEAD::InteHEAD()
...
Ewoms::RestartIO::InteHEAD&
Ewoms::RestartIO::InteHEAD::numActive(const int nactive)
{
...
Ewoms::RestartIO::InteHEAD&
Ewoms::RestartIO::InteHEAD::wellTableDimensions(const WellTableDim& wtdim)
{
...
Ewoms::RestartIO::InteHEAD&
Ewoms::RestartIO::InteHEAD::calendarDate(const TimePoint& timePoint)
{
...
Ewoms::RestartIO::InteHEAD&
Ewoms::RestartIO::InteHEAD::activePhases(const Phases& phases)
{
    const auto iphs =
...
Ewoms::RestartIO::InteHEAD&
Ewoms::RestartIO::InteHEAD::tuningParam(const TuningPar& tunpar)
{
...
Ewoms::RestartIO::InteHEAD&
Ewoms::RestartIO::InteHEAD::variousParam(const int version,
                                       const int iprog)
{
...
Ewoms::RestartIO::InteHEAD&
Ewoms::RestartIO::InteHEAD::wellSegDimensions(const WellSegDims& wsdim)
{
...
Ewoms::RestartIO::InteHEAD&
Ewoms::RestartIO::InteHEAD::regionDimensions(const RegDims& rdim)
{
...
std::time_t
Ewoms::RestartIO::makeUTCTime(const std::tm& timePoint)
{
...
Ewoms::RestartIO::InteHEAD::TimePoint
Ewoms::RestartIO::getSimulationTimePoint(const std::time_t start,
