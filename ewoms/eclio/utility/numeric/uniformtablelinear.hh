...
*/
#ifndef EWOMS_UNIFORMTABLELINEAR_H
#define EWOMS_UNIFORMTABLELINEAR_H
...
namespace Ewoms {
	...
	{
	    if (rp != ClosestValue) {
		EWOMS_THROW(std::runtime_error, "Only ClosestValue RangePolicy implemented.");
	    }
	    left_ = rp;
	}
    ...
    namespace utils
    {
        using Ewoms::UniformTableLinear;
    }

} // namespace Ewoms

#endif // EWOMS_UNIFORMTABLELINEAR_H
