...
*/
#ifndef EWOMS_NONUNIFORMTABLELINEAR_H
#define EWOMS_NONUNIFORMTABLELINEAR_H
...
namespace Ewoms
{
    ...
    {
        return Ewoms::linearInterpolation(x_values_, y_values_, x);
    }
    ...
    {
        return Ewoms::linearInterpolationDerivative(x_values_, y_values_, x);
    }
    ...
    ::inverse(const double y) const
    {
        if (y_values_.front() < y_values_.back()) {
            return Ewoms::linearInterpolation(y_values_, x_values_, y);
        } else {
            ...
            return Ewoms::linearInterpolation(y_values_reversed_, x_values_reversed_, y);
        }
    }
...
#endif // EWOMS_NONUNIFORMTABLELINEAR_H
