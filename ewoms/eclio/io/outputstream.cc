...
namespace {
    ...
    namespace Open
    {
        namespace Init
        {
            std::unique_ptr<Ewoms::EclIO::EclOutput>
            write(const std::string& filename,
                  const bool         isFmt)
            {
                return std::unique_ptr<Ewoms::EclIO::EclOutput> {
                    new Ewoms::EclIO::EclOutput {
        ...
        namespace Restart
        {
            std::unique_ptr<Ewoms::EclIO::ERst>
            read(const std::string& filename)
            {
                ...
                return std::unique_ptr<Ewoms::EclIO::ERst> {
                    new Ewoms::EclIO::ERst{filename}
                };
            }
...
Ewoms::EclIO::OutputStream::Init::~Init()
{}

Ewoms::EclIO::OutputStream::Init::Init(Init&& rhs)
    : stream_{ std::move(rhs.stream_) }
{}

Ewoms::EclIO::OutputStream::Init&
Ewoms::EclIO::OutputStream::Init::operator=(Init&& rhs)
{
...
Ewoms::EclIO::EclOutput&
Ewoms::EclIO::OutputStream::Init::stream()
{
    return *this->stream_;
}
...
Ewoms::EclIO::OutputStream::Restart::
...
Ewoms::EclIO::OutputStream::Restart::~Restart()
{}

Ewoms::EclIO::OutputStream::Restart::Restart(Restart&& rhs)
    : stream_{ std::move(rhs.stream_) }
{}

Ewoms::EclIO::OutputStream::Restart&
Ewoms::EclIO::OutputStream::Restart::operator=(Restart&& rhs)
{
    this->stream_ = std::move(rhs.stream_);
...
void Ewoms::EclIO::OutputStream::Restart::message(const std::string& msg)
{
...
Ewoms::EclIO::EclOutput&
Ewoms::EclIO::OutputStream::Restart::stream()
{
    return *this->stream_;
}
...
Ewoms::EclIO::OutputStream::RFT::~RFT()
{}

Ewoms::EclIO::OutputStream::RFT::RFT(RFT&& rhs)
    : stream_{ std::move(rhs.stream_) }
{}

Ewoms::EclIO::OutputStream::RFT&
Ewoms::EclIO::OutputStream::RFT::operator=(RFT&& rhs)
{
    this->stream_ = std::move(rhs.stream_);
...
Ewoms::EclIO::EclOutput&
Ewoms::EclIO::OutputStream::RFT::stream()
{
    return *this->stream_;
}
...
void
Ewoms::EclIO::OutputStream::SummarySpecification::
...
Ewoms::EclIO::OutputStream::SummarySpecification::~SummarySpecification()
{}
...
void Ewoms::EclIO::OutputStream::SummarySpecification::rewindStream()
{
...
void Ewoms::EclIO::OutputStream::SummarySpecification::flushStream()
{
    this->stream().flushStream();
}

Ewoms::EclIO::EclOutput&
Ewoms::EclIO::OutputStream::SummarySpecification::stream()
{
    return *this->stream_;
}
...
std::unique_ptr<Ewoms::EclIO::EclOutput>
Ewoms::EclIO::OutputStream::createSummaryFile(const ResultSet& rset,
                                            const int        seqnum,
                                            const Formatted& fmt,
                                            const Unified&   unif)
{
