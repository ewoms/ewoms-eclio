...
namespace Ewoms {
    ...
    /*
      ...
      variables 'EWOMS_ERRORS_EXCEPTION', 'EWOMS_ERRORS_WARN' and
      'EWOMS_ERRORS_IGNORE' are consulted
    */
    ...
    */
    ...
    void ParseContext::initEnv() {
        envUpdate( "EWOMS_ERRORS_EXCEPTION" , InputError::THROW_EXCEPTION );
        envUpdate( "EWOMS_ERRORS_WARN" , InputError::WARN );
        envUpdate( "EWOMS_ERRORS_IGNORE" , InputError::IGNORE );
        envUpdate( "EWOMS_ERRORS_EXIT1", InputError::EXIT1);
        envUpdate( "EWOMS_ERRORS_EXIT", InputError::EXIT1);
        envUpdate( "EWOMS_ERRORS_DELAYED_EXIT1", InputError::DELAYED_EXIT1);
        envUpdate( "EWOMS_ERRORS_DELAYED_EXIT", InputError::DELAYED_EXIT1);
    }
