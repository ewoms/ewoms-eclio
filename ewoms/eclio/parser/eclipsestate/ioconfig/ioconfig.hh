...
#ifndef EWOMS_IO_CONFIG_H
#define EWOMS_IO_CONFIG_H
...
namespace Ewoms {
    ...
    /*The IOConfig class holds data about input / ouput configurations
      ...
      To have equal sets of restart files written from Eclipse and EFlow for various
      ...
      not supported in EFlow; so to compare Eclipse results with EFlow results
      ...
      Unfortunately eflow and eclipse are not compatible across restarts. The
      RestartIO implementation can write restart files for flow -> flow restart
      or alternatively for eflow -> eclipse restart. This is regulated by the
      ...
      ecl_compatible_restart = false:
        ...
        3. The RestartIO::save() function will save eWoms (and OPM) specific vector OPM_IWEL
           and OPM_XWEL.
