...
namespace Ewoms {
    ...
    TableManager TableManager::serializeObject()
    {
        ...
        result.m_plymwinjTables = {{1, Ewoms::PlymwinjTable::serializeObject()}};
        result.m_skprwatTables =  {{2, Ewoms::SkprwatTable::serializeObject()}};
        result.m_skprpolyTables = {{3, Ewoms::SkprpolyTable::serializeObject()}};
        ...
        result.jfunc = std::make_shared<Ewoms::JFunc>(Ewoms::JFunc::serializeObject());
