...
bool rst_cmp(const Ewoms::RestartIO::RstState& rst1, const Ewoms::RestartIO::RstState& rst2) {
    int error_count = 0;
    ...
    if (foundRst1 && foundRst2) {
        ...
        for (int& seqn : seqnums1) {
            ...
            if (printKeywordOnly) {
                ...
                if (seqn > 0) {
                    const auto& rst_state1 = Ewoms::RestartIO::RstState::load(rst1, seqn);
                    const auto& rst_state2 = Ewoms::RestartIO::RstState::load(rst2, seqn);
